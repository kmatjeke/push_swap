...
#    Updated: 2019/09/17 11:35:28 by kmatjeke         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_arr_tolist.c ft_swapdata.c ft_sa.c ft_sb.c ft_ss.c ft_pushdata.c \
	  ...
	  ft_six_or_smaller.c push_swap.c ft_printlist.c ft_findmedian.c \
	  ft_sort_100.c ft_point_sort.c ft_sort.c ft_reverse_sort.c ft_sort_500.c \
...
OBJ = ft_arr_tolist.o ft_swapdata.o ft_sa.o ft_sb.o ft_ss.o ft_pushdata.o \
	  ...
	  ft_six_or_smaller.o push_swap.o ft_printlist.o ft_findmedian.o \
	  ft_sort_100.o ft_point_sort.o ft_sort.o ft_reverse_sort.o ft_sort_500.o \
